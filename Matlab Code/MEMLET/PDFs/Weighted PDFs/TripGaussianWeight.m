function [probability] = TripGaussianWeight(x,w,A,B,mu,mu2,mu3,sig1,sig2,sig3)
 metaData=struct('name','Triple Gaussian Weighted',...
                'PDF',   'TripGaussianWeight(x,w,A,B,mu,mu2,mu3,sig1,sig2,sig3)',...
                     'dataVar','x,w',...                    
